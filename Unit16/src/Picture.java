...
public class Picture extends SimplePicture 
{
  ...
  public void fixUnderwater()
  {
	  ...
	  for(Pixel[] rowArray : pixels)
	  {
		  for(Pixel pixelObj : rowArray)
		  {
			  pixelObj.setBlue((int)(pixelObj.getBlue() * 0.7));
			  pixelObj.setGreen((int)(pixelObj.getGreen() * 0.65));
			  pixelObj.setRed((int)(pixelObj.getRed() * 2.25));
		  }
	  }
  }
  ...
  public void mirrorArms()
  {
	  ...
	  int SecondMirrorPoint = 190;
	  for(int col = 239; col < 300; col++)
	  {
		  for(int row = 165; row < SecondMirrorPoint; row++)
		  {
			  topPixel = pixels[row][col];
			  bottomPixel = pixels[SecondMirrorPoint - row + SecondMirrorPoint][col];
			  bottomPixel.setColor(topPixel.getColor());
		  }
	  }
  }
  ...
  public void createCollage()
  {
    ...
    Picture flower2 = new Picture("/Users/jeremiahliao/Documents/GitHub/Liao_Jeremiah_APCSA-2021/Unit16/src/images/flower2.jpg");
    ...
    this.mirrorVertical();
    this.write("/Users/jeremiahliao/Documents/GitHub/Liao_Jeremiah_APCSA-2021/Unit16/src/images/collage.jpg");
  }
  
  public void myCollage()
  {
	  Picture beach = new Picture("/Users/jeremiahliao/Documents/GitHub/Liao_Jeremiah_APCSA-2021/Unit16/src/images/beach.jpg");
	  Picture smallerBeach = beach.scale(0.25, 0.3);
	  Picture water = new Picture("/Users/jeremiahliao/Documents/GitHub/Liao_Jeremiah_APCSA-2021/Unit16/src/images/water.jpg");
	  Picture smallerWater = water.scale(0.25, 0.3);
	  Picture flower1 = new Picture("/Users/jeremiahliao/Documents/GitHub/Liao_Jeremiah_APCSA-2021/Unit16/src/images/flower1.jpg");
	  this.copy(smallerBeach,0,0);
	  this.copy(smallerWater, 145, 0);
	  this.copy(flower1,273, 0);
	  smallerWater.zeroBlue();
	  this.copy(smallerWater, 375, 0);
	  this.mirrorVertical();
	  smallerWater.negate();
	  this.copy(smallerWater,50, 240);
	  smallerBeach.grayscale();
	  this.copy(smallerBeach, 200, 240);
	  this.write("/Users/jeremiahliao/Documents/GitHub/Liao_Jeremiah_APCSA-2021/Unit16/src/images/myCollage.jpg");
  }
