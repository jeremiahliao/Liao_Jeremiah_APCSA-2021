...
public class ElevensBoard extends Board {
	...
	private boolean containsPairSum11(List<Integer> selectedCards) {
		/* *** TO BE IMPLEMENTED IN ACTIVITY 9 *** */
		for(int sCard1 = 0; sCard1 < selectedCards.size(); sCard1++)
		{
			int Card1 = selectedCards.get(sCard1).intValue();
			for(int sCard2 = 0; sCard2 < selectedCards.size(); sCard2++)
			{
				int Card2 = selectedCards.get(sCard2).intValue();
